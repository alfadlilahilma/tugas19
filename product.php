...
if (isset($_POST['simpan'])) { //untuk create
  ...
  if ($product_name && $category_id && $product_code && $unit && $description && $price && $stock) { //untuk insert
    if ($op == 'edit') { //untuk update
     ...
     $sql1 = "insert into products (product_name, category_id, product_code, unit, description, price, stock) values ('$product_name', '$category_id', '$product_code', '$unit', '$description', '$price', '$stock')";
      $q1     = mysqli_query($koneksi, $sql1);
      if ($q1) {
